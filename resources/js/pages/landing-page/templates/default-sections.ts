export const defaultLandingPageSections = {
  sections: [
    ...
    {
      key: 'hero',
      title: 'Gesture - Project Management & Team Collaboration',
    ...
    // },
    {
      ...
      story_content: 'Founded by a team of project management enthusiasts and technology experts, Gesture was born from the frustration of scattered tools and inefficient workflows.',
      image: '',
    ...
    },
    {
      ...
      testimonials: [
        { name: 'Alex Thompson', role: 'Project Manager', company: 'TechCorp Inc.', content: 'Gesture has revolutionized how we manage projects and collaborate as a team.', rating: 5 }
      ]
    },
    {
      key: 'plans',
    ...
    },
    {
      ...
      faqs: [
        { question: 'How does Gesture work?', answer: 'Gesture allows you to create projects, assign tasks, track progress, and collaborate with your team efficiently.' }
      ]
    },
    {
      key: 'newsletter',
      title: 'Stay Updated with Gesture',
    ...
    },
    {
      key: 'contact',
      title: 'Get in Touch',
      subtitle: 'Have questions about Gesture? We\'d love to hear from you.',
