...
import { Users, Mail, Plus, Send, Trash2, Settings, Save, UserPlus, Crown, Shield, User, Clock, Building2, ExternalLink, AlertTriangle, Info, LogOut } from 'lucide-react';
                            ...
                            <div className="flex items-center gap-3 mt-1 text-xs text-gray-500">
                                ...
                                {workspace.invitations.length > 0 && (
                                    <div className="flex items-center gap-1">
                                        ...
                                        {workspace.invitations.length} {t('pending invitations')}
                                    </div>
                                )}
                            </div>
                        </div>
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
                            ...
                            {t('Pending Invitations')} ({workspace.invitations.length})
                        </CardTitle>
                        <CardDescription>
