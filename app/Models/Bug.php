...
class Bug extends Model
{
    ...
    protected $fillable = [
        ...
        'screenshot_path', 'video_path', 'video_duration_s',
        'guest_name', 'guest_email', 'source',
        'console_log', 'js_errors', 'perf_metrics',
        'ai_suggestions', 'due_at', 'first_response_at', 'resolved_at',
    ];
    ...
    {
        return $this->belongsToMany(BugTag::class, 'bug_tag_bug');
    }
