...
class Project extends Model
{
    ...
    protected $fillable = [
        ...
        'bug_retention_days', 'retention_widget_only',
        'live_url', 'staging_url', 'admin_username', 'admin_password_enc',
        'ga4_property_id', 'gsc_site_url', 'gbp_location_id', 'business_phone',
        'lead_event_name',
    ];
    ...
    public function bugWidgetKeys(): HasMany
    {
        return $this->hasMany(BugWidgetKey::class);
    }
