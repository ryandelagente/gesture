...
class LandingPageSetting extends Model
{
    ...
    {
        $settings = self::first();
        $app_name = config('is_saas', false) == true ? 'Gesture SaaS' : 'Gesture';            
        ...
        if (!$settings) {
            ...
            $defaultConfig = [
                'sections' => [
                    ...
                    [
                        ...
                        'screenshots_list' => [
                            [
                                'src' => '/storage/media/5/q-Gesture-saas-pic.png',
                            ...
                            [
                                'src' => '/storage/media/6/r-Gesture-saas-pic.png',
                            ...
                            [
                                'src' => '/storage/media/7/s-Gesture-saas-pic.png',
                                'alt' => 'Task Management',
                            ...
                            [
                                'src' => '/storage/media/16/ab-Gesture-saas-pic.png',
                            ...
                            [
                                'src' => '/storage/media/21/ag-Gesture-saas-pic.png',
                            ...
                            [
                                'src' => '/storage/media/11/w-Gesture-saas-pic.png',
                    ...
                    [
                        ...
                        'members' => [
                            ['name' => 'Sarah Johnson', 'role' => 'CEO & Founder', 'bio' => 'Former tech executive with 15+ years experience.', 'image' => '', 'linkedin' => '#', 'email' => 'sarah@Gesture.com'],
                            ['name' => 'Michael Chen', 'role' => 'CTO', 'bio' => 'Software architect with expertise in cloud solutions.', 'image' => '', 'linkedin' => '#', 'email' => 'michael@Gesture.com'],
                            ['name' => 'Emily Rodriguez', 'role' => 'Head of Product', 'bio' => 'Product strategist focused on user experience.', 'image' => '', 'linkedin' => '#', 'email' => 'emily@Gesture.com'],
                            ['name' => 'David Kim', 'role' => 'Lead Developer', 'bio' => 'Full-stack developer specializing in scalable applications.', 'image' => '', 'linkedin' => '#', 'email' => 'david@Gesture.com'],
                        ]
            ...
            $settings = self::create([
                ...
                'contact_email' => 'info@Gesture.com',
