    ...
    public function run(): void
    {
        $pages = [
            ...
            [
                ...
                'slug' => 'privacy-policy',
                'content' => "Privacy Policy for Gesture Project Management Platform: We are committed to <b>protecting your privacy and securing your data</b>.<br>This policy explains how we collect, use, and safeguard your information when using our project management services.<br>We collect only necessary data to provide excellent project management experiences and never sell your personal information.<br><b>Information We Collect:</b> &bull; Account details (name, email, company) &bull; Project data (tasks, files, timesheets) &bull; Usage analytics &bull; Communication within workspaces<br><b>How We Use Data:</b> &bull; Provide project management services &bull; Process payments and subscriptions &bull; Send project notifications &bull; Improve platform functionality<br><b>Data Security:</b> Enterprise-grade encryption, secure backups, and strict access controls protect your information.<br><b>Data Sharing:</b> We never sell your data. Information is only shared within your team and approved integrations.<br><b>Your Rights:</b> Access, update, or delete your data anytime. Contact privacy@Gesture.com for assistance.<br><b>Contact:</b> For privacy questions, reach us at privacy@Gesture.com or through our support center.",
                'meta_title' => 'Privacy Policy - Gesture',
                'meta_description' => 'Read our privacy policy to understand how Gesture collects, uses, and protects your personal information.',
                'is_active' => true,
                'sort_order' => 2
            ],
            [
